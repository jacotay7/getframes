...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("avalanche_input_noise_gain_exponent", 0.0),
        ("avalanche_input_noise_reference_gain", 0.5),
        ("avalanche_gain_nonuniformity", -0.1),
        ("ndr_bias_offset_adu_per_s", -1.0),
        ("ndr_bias_gain_coefficient_adu_per_s", -1.0),
        ("ndr_common_mode_gain_noise_adu_per_s", -1.0),
        ("ndr_avalanche_input_noise_reference_interval_s", 0.0),
        ("ndr_avalanche_input_noise_interval_exponent", -1.0),
        ("ndr_reset_settling_input_e", -1.0),
        ("ndr_reset_settling_scale_reads", -1.0),
        ("ndr_reset_settling_reference_interval_s", 0.0),
        ("ndr_reset_settling_interval_exponent", -1.0),
        ("read_noise_e", -1.0),
        ...
        ("bias_edge_axis", 2),
        ("bias_edge_secondary_amplitude_adu", -1.0),
        ("bias_edge_secondary_scale_px", -1.0),
        ("bias_edge_secondary_axis", 2),
